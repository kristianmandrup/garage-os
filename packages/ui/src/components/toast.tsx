...
const toastVariants = {
  ...
  destructive: 'border-red-500/50 bg-red-50 text-red-900 dark:bg-red-900/20 dark:text-red-400',
};

const Toast = React.forwardRef<
  HTMLLIElement,
  { variant?: keyof typeof toastVariants } & React.ComponentPropsWithoutRef<typeof ToastPrimitive.Root>
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ...
    className={cn(
      ...
      'hover:text-foreground focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2',
