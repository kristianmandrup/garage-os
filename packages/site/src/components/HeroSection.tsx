...
export function HeroSection({ onContact }: HeroSectionProps) {
  ...
  return (
    <section className="relative py-20 md:py-32 bg-gradient-to-br from-slate-50 via-blue-50/50 to-white dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 overflow-hidden">
